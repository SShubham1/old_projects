...
static PyObject *__pyx_f_4test_loop(int); /*proto*/
...
static PyObject *__pyx_f_4test_loop(int __pyx_v_x) {
  int __pyx_v_i;
 ...
 * 
 */
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_builtin_print, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("test.loop", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
 ...
 * loop(100000)             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __pyx_f_4test_loop(0x186A0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
